...
load("heart_post_policy (3).RData")
...
df_tx = df %>% filter(transplant == 1)
df = df %>% filter(!grepl("CAN_REM_DT", unique_event) & unique_date <= mdy("12-31-2023"))
